...
public class ApproveLoansTM {
    ...
    public ApproveLoansTM(String loanID, double amount, int installment, int monthlyInstallmentDate, Button button, String pendingLoan) {
        this.loanID = loanID;
        this.amount = amount;
        this.installment = installment;
        this.monthlyInstallmentDate = monthlyInstallmentDate;
