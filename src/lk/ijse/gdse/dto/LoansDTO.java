...
public class LoansDTO implements SuperEntity {
    ...
    public LoansDTO(String loanId, double amount, String loanTypeId, String accountId, int installments, double installmentAmount, Date issuedDate, int remainingInstallments, double remainingLoanAmount, int monthlyInstallmentDate, String settledOrNot, double interestAmount) {
        this.loanId = loanId;
        this.amount = amount;
